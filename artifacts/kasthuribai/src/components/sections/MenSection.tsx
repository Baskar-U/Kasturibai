...
const MEN_COLORS: Color[] = ["White", "Blue", "Black", "Red", "Navy", "Green"];
const MEN_SIZES: string[] = ["S", "M", "L", "XL", "XXL"];
const MEN_STYLES: Style[] = ["Office Wear", "Casual Wear", "Daily Wear", "Party Wear"];
...
export function MenSection({ onViewProduct }: MenSectionProps) {
  ...
  return (
    <section id="men" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-blue-50/50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-6 lg:gap-8">
          ...
          <FilterPanel
            ...
            availableSubcategories={MEN_SUBCATEGORIES}
            availableColors={MEN_COLORS}
            availableSizes={MEN_SIZES}
            availableStyles={MEN_STYLES}
            showAgeFilter={false}
